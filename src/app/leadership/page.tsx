  ...
  const leaders = [
    {
      ...
      summary: "Chartered Engineer (India), and AMIE with more than 7 years of professional valuation experience in residential, commercial, industrial, and institutional valuation.",
      qualifications: [
      ...
      message: "We believe every valuation should be accurate, transparent, and technically defendable.",
      skills: [
    ...
    },
    {
      ...
      licensingBrief: "Key Expertise: Real Estate Assessment & Quantity Surveys",
      image: "/naresh.png",
      summary: "Technical Manager with more than four years of experience in valuation consulting, technical due diligence, market research, asset assessment, and investment advisory.",
      qualifications: [
        "M.Tech Highway Engineering",
        "B.Tech Civil Engineering",
      ...
      message: "Deliver technically accurate, data-driven, and client-focused valuation services using modern engineering practices.",
      skills: [
  ...
  return (
    <div className="relative w-full overflow-hidden bg-white dark:bg-[#101828] transition-colors duration-300 page-fade-in flex flex-col min-h-[calc(100vh-80px)]">
      ...
      <section className="py-24 w-full px-6 md:px-12 lg:px-16 flex-grow flex items-center justify-center">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 w-full mx-auto max-w-6xl">
          {leaders.map((leader, index) => (
            <motion.div
              ...
              className="cursor-pointer group flex flex-col justify-between p-10 md:p-16 rounded-3xl bg-slate-50 dark:bg-[#1E293B] border border-slate-200/50 dark:border-slate-800/80 shadow-luxury hover:border-[#C9A227]/40 dark:hover:border-[#C9A227]/40 transition-all duration-300 w-full"
            >
              <div className="flex flex-col gap-8 w-full items-center text-center">
                
                {/* Visual Image/Initials Avatar */}
                <div className="relative h-36 w-36 mx-auto rounded-full bg-[#0B3158] dark:bg-[#101828] border-2 border-[#C9A227] flex items-center justify-center text-white shadow-md shadow-[#C9A227]/10 group-hover:scale-105 transition-transform duration-300 overflow-hidden shrink-0">
                  {leader.image ? (
                    <img 
                      src={leader.image} 
                      alt={leader.name} 
                ...
                <div className="space-y-3">
                  <h3 className="font-poppins text-3xl font-extrabold text-[#0B3158] dark:text-white leading-tight">
                    {leader.name}
                  </h3>
                  <p className="font-inter text-base text-[#C9A227] tracking-widest uppercase font-bold">
                    {leader.role}
                  </p>
                ...
                {/* Direct Contact Info */}
                <div className="w-full pt-8 border-t border-slate-200/60 dark:border-slate-800 flex flex-col gap-4 font-inter text-base items-center justify-center">
                  <a 
              ...
              <div className="w-full mt-10 pt-6 border-t border-slate-200/60 dark:border-slate-800 text-center">
                ...
                <div className="lg:col-span-5 flex flex-col gap-8 w-full">
                  ...
                  <div className="space-y-4">
                    ...
                    <ul className="flex flex-col gap-3 text-sm md:text-base text-slate-600 dark:text-slate-350">
                      {leaders[selectedLeader].qualifications.map((qual, idx) => (
                    ...
                    <ul className="flex flex-col gap-3 text-sm md:text-base text-slate-655 dark:text-[#C9A227]">
                      {leaders[selectedLeader].memberships.map((memb, idx) => (
                        <li key={idx} className="flex items-center gap-3">
                          ...
                          <span className="font-light text-slate-655 dark:text-slate-300">{memb}</span>
                        </li>
                      ))}
                    </ul>
                  </div>
                      ...
                      {leaders[selectedLeader].skills.map((skill) => (
                        <div key={skill.name} className="space-y-2">
                          <div className="flex items-center justify-between text-sm font-inter">
                            <span className="font-semibold text-slate-705 dark:text-slate-300">{skill.name}</span>
                            <span className="font-bold text-[#C9A227]">{skill.percentage}%</span>
                          </div>
